...
// â”€â”€ Your n8n Webhook URL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
Respond ONLY with a valid JSON object and nothing else â€” no markdown, no backticks, no preamble. Use this exact structure:

{
  "riskTier": "Unacceptable | High | Limited | Minimal",
  "riskTierReason": "One sentence explaining why this tier was assigned.",
  "euAiActArticles": ["Article X â€“ Name", "Article Y â€“ Name"],
  "complianceGaps": [
  ...
  "summaryVerdict": "2-3 sentence plain-English summary of the overall compliance situation and urgency."
    ...
    try {
      // â”€â”€ Step 1: Call Claude API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Step 2: Send result to n8n Webhook â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      try {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: "11px", color: "#64748b" }}>Regulation (EU) 2024/1689 Â· Powered by Claude Â· Connected to n8n</div>
        </div>
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        >
          {loading ? "â³ Analysing complianceâ€¦" : "â†’ Check EU AI Act Compliance"}
        </button>
        ...
        {webhookSent && (
          <div style={{
            ...
            âœ… Result logged to Google Sheets and email sent via n8n
          </div>
        )}
          ...
          <div style={{ marginTop: "32px" }}>
            ...
            {result.prohibitedPractices && result.prohibitedDetail && (
              <div style={{
                ...
                <div style={{ fontSize: "11px", color: "#ff9999", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "6px" }}>âš ï¸ Prohibited Practice Detected</div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  {result.requiredActions.map((a, i) => (
                    <div key={i} style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                      <div style={{ color: "#3b82f6", fontSize: "14px" }}>â†’</div>
